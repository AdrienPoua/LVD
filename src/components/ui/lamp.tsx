  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className='mt-8 bg-clip-text py-4 text-center text-4xl font-medium tracking-tight text-foreground md:text-7xl'
      >
        {title}
      </motion.h1>
    </LampContainer>
...
export const LampContainer = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <div
      className={cn(
        'relative z-0 flex min-h-[45rem] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-background',
        className,
      )}
    >
