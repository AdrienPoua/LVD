...
export const metadata: Metadata = {
  metadataBase: new URL('https://ldvart.fr'),
  ...
  twitter: {
    ...
    creator: '@ldvart',
    title: "LDV ART - Transport & Stockage d'Œuvres d'Art",
    description: "Expert en logistique d'art : transport, stockage et manipulation sécurisée des œuvres.",
...
const JSONLD = {
  ...
  sameAs: ['https://www.instagram.com/ldvart.transports/'],
  address: {
    '@type': 'PostalAddress',
